 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const HS=new xe(H.comparator);function xn(){return HS}const dv=new xe(H.comparator);function Zs(...t){let e=dv;for(const n of t)e=e.insert(n.key,n);return e}function pv(t){let e=dv;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function wr(){return pi()}function gv(){return pi()}function pi(){return new Bs(t=>t.toString(),(t,e)=>t.isEqual(e))}const KS=new xe(H.comparator),WS=new ut(H.comparator);function ae(...t){let e=WS;for(const n of t)e=e.add(n);return e}const GS=new ut(pe);function QS(){return GS}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Df{constructor(e,n,r,s){this.targetId=e,this.fromCache=n,this.Fi=r,this.Bi=s}static Li(e,n){let r=ae(),s=ae();for(const i of n.docChanges)switch(i.type){case 0:r=r.add(i.doc.key);break;case 1:s=s.add(i.doc.key)}return new Df(e,n.fromCache,r,s)}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
